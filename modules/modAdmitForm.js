...
function setDataMediationOrders(){
  frmAdmitForm.segOtherMediations.widgetDataMap = {labelmediationOthers:"labelmediationOthers"};
  segDataMediationOrders = [{labelmediationOthers:{text:"Resume All Home Medications"}}];
  frmAdmitForm.segOtherMediations.setData(segDataMediationOrders);	
}

var segDataPRNMeds = [];
function setDataPRNMeds(){
   frmAdmitForm.segmentPRNMeds.widgetDataMap = {labelmediationOthers:"labelmediationOthers"};
  segDataPRNMeds = [
    				{labelmediationOthers:{text:"Albuterol 2.5 mg via Ben q6h prn sob"}},
                    {labelmediationOthers:{text:"Ambien 5 mg po qhs prn insomnia"}},
                    {labelmediationOthers:{text:"Ativan 1 mg po/iv q6h prn agitation"}},
                    {labelmediationOthers:{text:"Clonidine 0.1 mg po q 6h prn SBP >= 160"}},
                    {labelmediationOthers:{text:"Dilaudid 1 mg iv q4h prn pain scale 1-5"}},
    				{labelmediationOthers:{text:"Dilaudid 2 mg iv q4h prn pain scale 6-10"}},
                    {labelmediationOthers:{text:"Electrolyte replacement protocol"}},
                    {labelmediationOthers:{text:"Hydralazine 10 mg iv q 2h prn SBP >= 160"}},
                    {labelmediationOthers:{text:"Ibuprofen 400 mg po q 6h prn fever/pain"}},
                    {labelmediationOthers:{text:"Labetolol 10 mg iv q 2h prn SBP >= 160"}},
    				{labelmediationOthers:{text:"Maalox 30 cc q 6h prn indigestion"}},
                    {labelmediationOthers:{text:"Nicotine patch 21 mcg/hr q day"}},
                    {labelmediationOthers:{text:"Norco 10/325 po q 6h prn pain"}},
                    {labelmediationOthers:{text:"Phenergan 12.5 mg iv q 6hprn n/v"}},
                    {labelmediationOthers:{text:"Restoril 15 mg po qhs prn insomnia"}},
    				{labelmediationOthers:{text:"Tylenol 650 mg po q 6h prn fever/pain"}},
                    {labelmediationOthers:{text:"Zofran 4 mg iv q 4h prn n/v"}}
 ...
 function setDataImagingTestsXRays(){
  frmAdmitForm.segmentImagingTestsXRays.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
  segImagingTestsXRays = [
                    {labelmediationOthers:{text:"Chest X-Ray Portable"}},
                    {labelmediationOthers:{text:"KUB"}},
                    {labelmediationOthers:{text:"PA/Lateral"}},
                    {labelmediationOthers:{text:"Other"}}
     				];
  frmAdmitForm.segmentImagingTestsXRays.setData(segImagingTestsXRays);
 }
 var segImaginTestsUS = [];
 function setDataImaginTestsUS(){
  	frmAdmitForm.segmentImaginTestsUS.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
 	segImaginTestsUS = [
                      {labelmediationOthers:{text:"Abdomen"}},
                      {labelmediationOthers:{text:"Doppler - Arterial"}},
                      {labelmediationOthers:{text:"Doppler - Venous"}},
                      {labelmediationOthers:{text:"Pelvis"}},
      				  {labelmediationOthers:{text:"Renal"}}
     				];
  	frmAdmitForm.segmentImaginTestsUS.setData(segImaginTestsUS);
 }
 var segImagingTestsCT = [];
 function setDataImagingTestsCT(){
  	frmAdmitForm.segmentImagingTestsCT.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
 	segImagingTestsCT = [
                      {labelmediationOthers:{text:"Abdomen and Pelvis no contrast Stone Protocol"}},
                      {labelmediationOthers:{text:"Abdomen and Pelvis with and without contras"}},
                      {labelmediationOthers:{text:"Brain no contrast"}},
                      {labelmediationOthers:{text:"Brain with contrast"}},
       				  {labelmediationOthers:{text:"Chest PE Protocol"}},
                      {labelmediationOthers:{text:"Chest with and without contrast"}}
     				];
  	frmAdmitForm.segmentImagingTestsCT.setData(segImagingTestsCT);
 }
 var segImagingTestsMRI = [];
 function setDataImagingTestsMRI(){
  	frmAdmitForm.segmentImagingTestsMRI.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
 	segImagingTestsMRI = [
                      {labelmediationOthers:{text:"MRA Neck"}},
                      {labelmediationOthers:{text:"MRCP"}},
                      {labelmediationOthers:{text:"MRI C Spine"}},
                      {labelmediationOthers:{text:"MRI L/S Spine"}},
      				  {labelmediationOthers:{text:"MRI/MRA Brain"}}
     				];
  	frmAdmitForm.segmentImagingTestsMRI.setData(segImagingTestsMRI);
 }
 var segImagingTestsEKG = [];
 function setDataImagingTestsEKG(){
  	frmAdmitForm.segmentImagingTestsEKG.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
 	segImagingTestsEKG = [
                      {labelmediationOthers:{text:"EKG"}}
     				];
...
var segSpecialityConsults = [];
 function setDataSpecialityConsults(){
  	frmAdmitForm.segmentSpecialityConsults.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
 	segSpecialityConsults = [
                      {labelmediationOthers:{text:"Cardiology"}},
     				  {labelmediationOthers:{text:"Gen Surgery"}},
      				  {labelmediationOthers:{text:"GI"}},
     				  {labelmediationOthers:{text:"ID"}},
      				  {labelmediationOthers:{text:"Nephrology"}},
     				  {labelmediationOthers:{text:"Neurology"}},
      				  {labelmediationOthers:{text:"Podiatry"}},
     				  {labelmediationOthers:{text:"Pulmonology"}}
     				];
  	frmAdmitForm.segmentSpecialityConsults.setData(segSpecialityConsults);
 }
 var segBloodTests1 = [];
 function setDataBloodTests1(){
  frmAdmitForm.segmentBloodTests1.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
  segBloodTests1 = [
                    {labelmediationOthers:{text:"Blood CX"}},
                    {labelmediationOthers:{text:"BMP"}},
                    {labelmediationOthers:{text:"CBC"}},
                    {labelmediationOthers:{text:"CKMB"}}
     				];
 ...
 function setDataBloodTests2(){
  frmAdmitForm.segmentBloodTests2.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
  segBloodTests2 = [
                    {labelmediationOthers:{text:"CMP"}},
                    {labelmediationOthers:{text:"D Dimer"}},
                    {labelmediationOthers:{text:"FLP"}},
                    {labelmediationOthers:{text:"LFT"}}
     				];
  frmAdmitForm.segmentBloodTests2.setData(segBloodTests2);
 }
var segBloodTests3 = [];
 function setDataBloodTests3(){
  frmAdmitForm.segmentBloodTests3.widgetMap =   {labelmediationOthers:"labelmediationOthers"};
  segBloodTests3 = [
                    {labelmediationOthers:{text:"PT"}},
                    {labelmediationOthers:{text:"PTT"}},
                    {labelmediationOthers:{text:"Trop"}},
                    {labelmediationOthers:{text:"TSH"}}
     				];
 ...
 function setDataModeofTansport(){
 	frmAdmitForm.segmodeOfTransport1.widgetMap = {imageModeOfTransport:"imageModeOfTransport",
                                                 labelModeOfTransport:"labelModeOfTransport"};
    frmAdmitForm.segmodeOfTransport2.widgetMap = {imageModeOfTransport:"imageModeOfTransport",
                                                 labelModeOfTransport:"labelModeOfTransport"};
                                                 
    
   segModeOfTransport1 = [
                           {imageModeOfTransport:{src:"ambulanceinactive"},labelModeOfTransport:{text:"Ambulance"}},
                           {imageModeOfTransport:{src:"helicopterinactive"},labelModeOfTransport:{text:"Helicopter"}},
                           {imageModeOfTransport:{src:"vechicleinactive"},labelModeOfTransport:{text:"Personal Vehicle"}}
                         ];
   segModeOfTransport2 =[
     						{imageModeOfTransport:{src:"requestinactive"},labelModeOfTransport:{text:"Request Transportation"}},
							{imageModeOfTransport:{src:"teaminactive"},labelModeOfTransport:{text:"Specialty Team"}},
     						{imageModeOfTransport:{src:"unkowninactive"},labelModeOfTransport:{text:"Unknown"}}
   						];
...
function setDataSetmentComorbidity(){
  frmAdmitForm.SetmentComorbidity.setWidgetDataMap = {btnComorbidity1:"btnComorbidity1",
  ...
  SetmentComorbidityData = [{btnComorbidity1:{text:"CAD",onClick:onClickComorbidity1},
                             btnComorbidity2:{text:"CHF",onClick:onClickComorbidity2},
                            btnComorbidity3:{text:"CKD",onClick:onClickComorbidity3},
                            btnComorbidity4:{text:"DM",onClick:onClickComorbidity4},
                            btnComorbidity5:{text:"HTN",onClick:onClickComorbidity5}}];
...
function setDataSetmentAllergies(){
  frmAdmitForm.SegmentAllergies.setWidgetDataMap = {btnComorbidity1:"btnComorbidity1",
                                                      btnComorbidity2:"btnComorbidity2",
                                                      btnComorbidity3:"btnComorbidity3",
                                                      btnComorbidity4:"btnComorbidity4",
                                                      btnComorbidity5:"btnComorbidity5"};
  setmentAllergiesData = [{btnComorbidity1:{text:"Codeine",onClick:onClickAllergies1},
                             btnComorbidity2:{text:"Iodine",onClick:onClickAllergies2},
                            btnComorbidity3:{text:"PCN",onClick:onClickAllergies3},
                            btnComorbidity4:{text:"Sulfa",onClick:onClickAllergies4},
                            btnComorbidity5:{text:"HTN",onClick:onClickAllergies5}}];
...
function setSegmentSepsisScreeingSIRSData(){
  ...
  segmentSepsisScreeingSIRSData = [
                    {labelmediationOthers:{text:"HR => 90"},skin:"slLabelMediationOrders"},
                    {labelmediationOthers:{text:"RR => 20"},skin:"slLabelMediationOrders"},
                    {labelmediationOthers:{text:"Temperature < 96.8 or > 100.4"},skin:"slLabelMediationOrders"},
                    {labelmediationOthers:{text:"WBC => 12,000 or <= 4,000 or > 10% Bands"},skin:"slLabelMediationOrders"},
                    {labelmediationOthers:{text:"No SIRS Criteria"},skin:"slLabelMediationOrders"},
     				];
...
function setDataSegmentPatientStatusCodeStatus(){
  ...
  segmentPatientStatusCodeStatusData = [
                                          {FlexContainerPatientStatusCodeStatus1:{onClick:onClickPatientStatusCode1},
