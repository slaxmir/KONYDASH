...
function submitRegistrationForm() {
    ...
    var temp = null;
    if ((currentForm.TextFieldRegFirstName.text == temp) || (currentForm.TextFieldRegLastName.text == temp) || (currentForm.TextFieldRegEmailId.text == temp) || (currentForm.TextFieldRegUserName.text == temp) || (currentForm.TextFieldRegCaptcha.text == temp)) {
