...
function setDataSetmentManageAlertsDirectAdmission() {
    frmConfigurationAlerts.SegmentDirectAdmission.setWidgetDataMap = {
    ...
    setmentManageAlertsDirectAdmisssionData = [{
        labelManageAlertsType: {
            text: "Bed Unavailable"
        },
        btnManageAlertsEmail: {
            skin: "sknBtnManageAlerts",
            onClick: onClickManageAlertDirectAdmissionEmail
        },
        btnManageAlertText: {
            skin: "sknBtnManageAlertsText",
            onClick: onClickManageAlertDirectAdmissionText
        },
        btnManageAlertNotification: {
            skin: "sknBtnManageAlertsNotification",
            onClick: onClickManageAlertDirectAdmissionNotification
        }
    }, {
        labelManageAlertsType: {
            text: "Bed Available Pending Discharges"
        },
        btnManageAlertsEmail: {
            skin: "sknBtnManageAlerts",
            onClick: onClickManageAlertDirectAdmissionEmail
...
function setDataSetmentManageAlertsEDReferral() {
    frmConfigurationAlerts.SegmentEDReferral.setWidgetDataMap = {
        labelManageAlertsType: "labelManageAlertsType",
        btnManageAlertsEmail: "btnManageAlertsEmail",
        btnManageAlertText: "btnManageAlertText",
        btnManageAlertNotification: "btnManageAlertNotification"
    ...
    segmentManageAlertsEDReferralData = [{
        ...
        btnManageAlertsEmail: {
            skin: "sknBtnManageAlerts",
            onClick: onClickManageAlertEDReferralEmail
        },
        btnManageAlertText: {
            skin: "sknBtnManageAlertsText",
            onClick: onClickManageAlertEDReferralText
        },
        btnManageAlertNotification: {
            skin: "sknBtnManageAlertsNotification",
            onClick: onClickManageAlertEDReferralNotification
        }
    }, {
        labelManageAlertsType: {
            text: "Bed Available Pending Discharges"
...
function setDataSetmentManageAlertsPsychAdmission() {
    frmConfigurationAlerts.SegmentPsychAdmission.setWidgetDataMap = {
        labelManageAlertsType: "labelManageAlertsType",
        btnManageAlertsEmail: "btnManageAlertsEmail",
        btnManageAlertText: "btnManageAlertText",
        btnManageAlertNotification: "btnManageAlertNotification"
    ...
    segmentManageAlertsPsychAdmissionData = [{
        ...
        btnManageAlertsEmail: {
            skin: "sknBtnManageAlerts",
            onClick: onClickManageAlertPsychAdmissionEmail
        },
        btnManageAlertText: {
            skin: "sknBtnManageAlertsText",
            onClick: onClickManageAlertPsychAdmissionText
        },
        btnManageAlertNotification: {
            skin: "sknBtnManageAlertsNotification",
            onClick: onClickManageAlertPsychAdmissionNotification
        }
    }, {
        labelManageAlertsType: {
            text: "Bed Available Pending Discharges"
